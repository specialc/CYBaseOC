    ...
    if (success == 0) {
        ...
        while (temp_addr != NULL) {
            if (temp_addr->ifa_addr->sa_family == AF_INET) {
                ...
                if ([[NSString stringWithUTF8String:temp_addr->ifa_name] isEqualToString:@"pdp_ip0"] || [[NSString stringWithUTF8String:temp_addr->ifa_name] isEqualToString:@"en0"]) {
