...
@implementation CY_RefreshHeader
...
- (UIImageView *)arrowView {
    if (!_arrowView) {
        ...
        [self addSubview:_arrowView = imageView];
    }
    return _arrowView;
}
...
- (UIActivityIndicatorView *)loadingView {
    if (!_loadingView) {
        ...
        [self addSubview:_loadingView = view];
    }
    return _loadingView;
}
...
- (void)prepare {
    ...
    self.stateLabel.font = @"14px".cc_font;
